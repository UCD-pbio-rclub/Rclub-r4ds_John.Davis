...
##     <int> <chr>     <dbl>         <dbl>
## 1    1545   IAH        11  3.661053e-04
## 2    1714   IAH        20  6.656460e-04
## 3    1141   MIA        33  9.518316e-03
## 4     725   BQN       -18 -2.458345e-03
## 5     461   ATL       -25 -1.313991e-04
## 6    1696   ORD        12  1.232640e-04
## 7     507   FLL        19  1.976017e-04
## 8    5708   IAD       -14 -1.875896e-04
## 9      79   MCO        -8 -1.050075e-04
## 10    301   ORD         8  8.217602e-05
...
flights %>% group_by(dest) %>%
  ...
  ungroup() %>%
  group_by(carrier) %>%
  mutate(locations = length(unique(dest))) %>%
  arrange(desc(locations)) %>%
  select(carrier, locations)
```

```
## Source: local data frame [325,397 x 2]
## Groups: carrier [16]
## 
##    carrier locations
##      <chr>     <int>
